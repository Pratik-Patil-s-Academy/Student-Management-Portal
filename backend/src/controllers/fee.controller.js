...
import { FeeReceipt } from '../models/feeReceipt.model.js';
import { Student } from '../models/student.model.js';
import asyncHandler from '../utils/asyncHandler.js';
import * as feeService from '../services/fee.service.js';
import { sendInstallmentReceiptEmail, sendBulkInstallmentReceipts } from '../services/email.service.js';
...
export const makeFeePayment = asyncHandler(async (req, res) => {
  const {
    studentId,
    amount,
    paymentMode,
...
export const getStudentReceipt = asyncHandler(async (req, res) => {
  const { studentId } = req.params;
...
export const sendInstallmentEmail = asyncHandler(async (req, res) => {
...
export const sendStudentAllEmails = asyncHandler(async (req, res) => {
  const { studentId } = req.params;
...
export const getAllStudentsWithFeeStatus = asyncHandler(async (req, res) => {
