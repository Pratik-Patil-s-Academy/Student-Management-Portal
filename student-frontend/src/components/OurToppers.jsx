...
const toppers = [
    ...
    { name: "Priya Sharma", score: "98.2%", exam: "HSC Board", rank: "College Topper" },
    { name: "Rahul Deshmukh", score: "99.1%", exam: "JEE Advanced", rank: "AIR 512" },
    { name: "Anjali Gupta", score: "98.9%", exam: "MHT-CET", rank: "State Rank 45" },
];

function OurToppers() {
    return (
        <section className="section-padding bg-accent/30 overflow-hidden">
            ...
            <div className="flex overflow-hidden">
                ...
                >
                    ...
                    {[...toppers, ...toppers, ...toppers].map((student, i) => (
                        <Card key={i} className="w-[300px] shrink-0 border-border bg-background">
