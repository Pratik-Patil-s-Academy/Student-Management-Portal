...
import {
  ...
  FaGraduationCap, FaBook, FaChartBar, FaTrophy
} from 'react-icons/fa';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <h1 className="text-3xl md:text-4xl font-bold text-[#2C3E50]">Tests</h1>
        <div className="flex flex-row flex-wrap gap-2 w-full md:w-auto">
          <Link
            to="/tests/performance"
            className="flex-1 md:flex-none flex justify-center items-center gap-2 bg-amber-500 hover:bg-amber-600 text-white px-4 py-2.5 md:px-5 md:py-3 rounded-lg shadow-md transition-all text-sm md:text-base whitespace-nowrap"
          >
