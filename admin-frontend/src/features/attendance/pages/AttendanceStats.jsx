...
import { getAllStudents } from '../../student/services/studentService';
import { FaArrowLeft, FaChartBar, FaFilter, FaUsers, FaUserGraduate } from 'react-icons/fa';

const AttendanceCharts = React.lazy(() => import('../components/AttendanceCharts'));
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      {stats && selectedStudent && (
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
            ...
            {/* Pie Chart */}
            <React.Suspense fallback={<div className="h-48 w-full bg-gray-50 animate-pulse rounded-xl"></div>}>
              <AttendanceCharts 
                stats={stats} 
      ...
      {batchStats.length > 0 && selectedBatch && (
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
          ...
          <React.Suspense fallback={<div className="h-64 h-full bg-gray-50 animate-pulse rounded-xl"></div>}>
            <AttendanceCharts 
